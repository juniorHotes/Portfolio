                ...
                <div className="header-container">
                    <div className="profile">
                        <div className="content-img">
                            <img src="https://avatars2.githubusercontent.com/u/48397952?s=460&u=ce14bd1c65778a22a65bc6f893cd88762587311b&v=4"
                                alt="Profile" />
                        </div>
                        <div>
                            ...
                            <div className="social-midias">
                                ...
                                <a href="https://www.linkedin.com/feed/?trk=homepage-basic_google-one-tap-submit"
                                    target="_blank" rel="noopener" className="sc-cpHetk QZIQu"><svg stroke="currentColor"
                    ...
                    <div className="about-me">
                        <h1 className="titles">Um pouco sobre mim</h1>
                        <p id="txt-about"></p>
                        <div className="technologies">
                            <h1 className="titles">Abilidades</h1>
                            <ul></ul>
                        </div>
